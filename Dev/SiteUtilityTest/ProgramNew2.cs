...
namespace SiteUtilityTest
{
    public class ProgramNew2
    {
        ...
        {
            string releaseName = "SiteUtilityTest - IWH to Kidney Care Oklahoma";
                        ...
                        foreach (PracticeSite psite in pm.PracticeSiteCollection)
                        {
                            if (psite.URL.Contains(runPM) && psite.URL.Contains(runPractice))
                            {
                                ...
                                if (psite.IsIWH == "true")
                                {
                                    ...
                                    CheckIfPageExists(psite.URL, "Test");
                                    //SiteLogUtility.Log_Entry("ModifyView for Quality Iwh...", true); 
                                    //modifyView(psite.URL, slu.pageNameQuality + ".aspx", slu.webpartQualityIwh);
                                }
                            }
                        }
                    }
