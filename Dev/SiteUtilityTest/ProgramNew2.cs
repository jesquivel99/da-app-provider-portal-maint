...
namespace SiteUtilityTest
{
    public class ProgramNew2
    {
        ...
        public void InitiateProgNew2()
        {
            ...
            string releaseName = "SiteUtilityTest - ProgramNew2";
        ...
        public void DialysisStartsSetup(string sitrUrl)
        {
            try
            {
                ...
                objSiteFiles.DocumentUpload(sitrUrl, @"C:\Projects\PracticeSite-Core\Dev\PracticeSiteTemplate\Config\cePrac_CarePlans.html", "SiteAssets");
                objSiteFiles.DocumentUpload(sitrUrl, @"C:\Projects\PracticeSite-Core\Dev\PracticeSiteTemplate\Config\SW_RD_Referrals.jpg", "SiteAssets/Img");
